...
import { buildFrontierMap, getOpenWorldGroundY, FRONTIER_THEME } from "./frontier-map.js";

export { getOpenWorldGroundY };
...
const THEMES = {
  ...
  neblina: {
    mode: "horror",
    name: "Perseguido na Neblina",
    scale: 1,
    sky: 0x0a1810,
    fog: 0x081408,
    floorColor: 0x1a2820,
    wallColor: 0x121a14,
    accentColor: 0x1a3020,
    ceilColor: 0x0a100c,
    woodColor: 0x1a2018,
    propTint: { barrel: 0x111811, supply: 0x0a120a },
    spawnCT: { x: -18, z: 0 },
    spawnT: { x: 18, z: 0 },
    bombSites: [{ x: 12, z: -8, id: "A" }, { x: 12, z: 8, id: "B" }],
    monsterSpawns: [
