...
const SLOTS = [
  { x: 0, z: 0.8, color: 0xf0a030, mine: true, scale: 1.75, padRadius: 0.92 },
  { x: -1.5, z: 0.0, color: 0x2266aa, scale: 1.42, padRadius: 0.76 },
  { x: 1.5, z: 0.0, color: 0xc9a227, scale: 1.42, padRadius: 0.76 },
  { x: 0, z: -0.5, color: 0x888899, scale: 1.42, padRadius: 0.76 },
];
